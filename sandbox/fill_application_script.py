...
async def run_generated_script():
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            # Action 8
            await _try_locate_and_act(page, "xpath=//html/body/div[4]/div/div[2]/form/div[3]/ul/li[1]/div/div[2]/ul/li[1]/label/input", "click", step_info="Step 1, Action 8")
            # Action 9
            ...
            # --- Step 2 ---
            # Action 11
            await _try_locate_and_act(page, "xpath=//html/body/div[4]/div/div[2]/form/div[4]/ul/li[1]/div/div[2]/ul/li[1]/label/input", "click", step_info="Step 2, Action 1")
            # Action 12
            await _try_locate_and_act(page, "xpath=//html/body/div[4]/div/div[2]/form/div[4]/ul/li[2]/div/div[2]/ul/li[2]/label/input", "click", step_info="Step 2, Action 2")
            # Action 13
            await _try_locate_and_act(page, "xpath=//html/body/div[4]/div/div[2]/form/div[7]/ul/li[1]/div/div[2]/ul/li[2]/label/input", "click", step_info="Step 2, Action 3")
            # Action 14
            await _try_locate_and_act(page, "xpath=//html/body/div[4]/div/div[2]/form/div[7]/ul/li[2]/div/div[2]/ul/li[1]/label/input", "click", step_info="Step 2, Action 4")
            # Action 15
            await _try_locate_and_act(page, "xpath=//html/body/div[4]/div/div[2]/form/div[8]/ul/li[1]/div/div[2]/textarea", "fill", text=replace_sensitive_data("earning hacking belts on pwn.college website. The website is made by members of Order of the Overflow who organized the Def Con CTF in Las Vegas", SENSITIVE_DATA), step_info="Step 2, Action 5")
            # Action 16
            await _try_locate_and_act(page, "xpath=//html/body/div[4]/div/div[2]/form/div[8]/ul/li[2]/div/div[2]/textarea", "fill", text=replace_sensitive_data("Palantir and Anduril are two companies that are focused on making America and the world safer. Working at Palantir to me would be a mix of working at a startup, but working in defense technologies vs SaaS", SENSITIVE_DATA), step_info="Step 2, Action 6")
            # Action 17
            # Unsupported action type: select_dropdown_option (Step 2, Action 7)
            # Action 18
            ...
            final_message = replace_sensitive_data("Successfully filled the job application form with the provided resume data. Skipped the location field as instructed. Filled fields including: Full name (Spencer Willett), Email (spencer.willett15@gmail.com), Phone (858-319-9931), Current company (Software Engineer), LinkedIn URL (https://www.linkedin.com/in/spencer-willett), GitHub URL (https://www.github.com/GiveThanksAlways), Portfolio URL (givethanksalways.github.io), Language skills (English and Spanish), University (Arizona State University - Tempe), Work authorization (Yes), Security clearance (No and Yes for eligibility), Favorite project (earning hacking belts on pwn.college website), Why Palantir (Palantir and Anduril are two companies focused on making America and the world safer), Veteran status (I am not a protected veteran), and Disability status (No, I do not have a disability). The form was not submitted as per instructions.", SENSITIVE_DATA)
            print(final_message)
